...
def play_game(msg):
    ...
    if "fish" in msg.text:
        if Turn.player1turn:
            msg.reply(f"Player 1's Turn, {Points.p1} points\r"+str(fish()))
        else:
            msg.reply(f"Player 2's Turn, {Points.p2} points\r"+str(fish()))
...
def fish():    
    ...
    if num == 1:
        return str(reply.uc + reply.fish1)
        ...
        if Turn.player1turn:
            ...
            Points.p2 += 1
        return str(reply.uc + reply.fish2)
        ...
        if Turn.player1turn:
            ...
            Points.p2 += 3
        return str(reply.uc + reply.fish3)
        ...
        if Turn.player1turn:
            ...
            Points.p2 += 5
        return str(reply.uc + reply.fish4)
        ...
        if Turn.player1turn:
            ...
            Points.p2 += 10
        return str(reply.uc + reply.fish5)
        ...
        if Turn.player1turn:
            ...
            Points.p2 = 0
        Turn.switch = True
        return str(reply.uc + "an electric eel! You have zero points and your Turn is over.")
